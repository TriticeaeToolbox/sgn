...
export function WizardSetup(main_id) {
    ...
    jQuery('#wizard-download-genotypes-marker-set-list-id').html(lo.listSelect('wizard-download-genotypes-marker-set-list-id', ['markers'], 'Select a loci', 'refresh', undefined));
