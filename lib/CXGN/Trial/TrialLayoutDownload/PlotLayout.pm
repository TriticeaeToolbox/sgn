...
sub retrieve {
    ...
    my @possible_cols = ('plot_name','plot_id','accession_name','accession_id','plot_order','plot_number','block_number','is_a_control','rep_number','range_number','row_number','col_number','seedlot_name','seed_transaction_operator','num_seed_per_plot','weight_gram_seed_per_plot','pedigree','purdy_pedigree','filial_generation','location_name','trial_name','year', 'planting_date', 'synonyms','variety','tier','plot_geo_json');
